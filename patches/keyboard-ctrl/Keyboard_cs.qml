...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            CharKey { label: "1"; shifted: "1"; leftSide: true; }
            ...
            CharKey { label: "0"; shifted: "0"; rightSide: true; }
        }
        ...
        Item {
            ...
            CharKey        { id: dashKey;     label: "-"; shifted: "-"; extended: ["_", "/", "|"]; extendedShifted: ["_", "/", "|"]; anchors.left: symShiftKey.right; height: parent.height; }
            CtrlKey        { id: ctrlKey;                                 anchors.left: dashKey.right; height: parent.height; }
            CharKey        { id: commaKey;    label: ","; shifted: ","; extended: ["'", "\"", ";", ":", "@", "&", "(", ")"]; extendedShifted: ["'", "\"", ";", ":", "@", "&", "(", ")"]; anchors.left: ctrlKey.right; height: parent.height; }
