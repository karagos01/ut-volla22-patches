...
Item {
    ...
    // Phone layout: true when screen is narrower than 60gu
    readonly property bool phoneLayout: !partialWidth

    // Clock date updated periodically for phone status bar
    property date panelClockDate: new Date()

    Timer {
        id: panelClockTimer
        interval: 15000
        running: root.phoneLayout
        repeat: true
        onTriggered: root.panelClockDate = new Date()
    }
