...
Item {
    ...
    Item {
        ...
        Flickable {
            ...
            anchors.top: parent.top; anchors.bottom: parent.bottom; anchors.left: parent.left; anchors.leftMargin: root.contentRightInset; anchors.right: parent.right; anchors.rightMargin: root.contentRightInset
